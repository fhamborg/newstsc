...
echo "starting job"
python controller.py --dataset newstsc --experiments_path /data/scc/fhamborg/exp0 --continue_run True --num_workers -1 --results_path results/results_newstsc0 --cuda_devices SGE_GPU --combi_id 0
