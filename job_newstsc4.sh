...
echo "starting job"
python controller.py --dataset newstsc --experiments_path /data/scc/fhamborg/exp4 --continue_run True --num_workers -1 --results_path results/results_newstsc4 --cuda_devices SGE_GPU --combi_mode tpplace --combi_id 4
