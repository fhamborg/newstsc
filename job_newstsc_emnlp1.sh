#!/bin/bash
###################################
#$ -N newstscemn1           # the name of the job
...
#$ -o /data/scc/fhamborg/newstscemn1.out
#$ -e /data/scc/fhamborg/newstscemn1.err
#$ -m bea
...
echo "starting job"
python controller.py --dataset newstsc --experiments_path /data/scc/fhamborg/exp_newstscemn1 --continue_run True --num_workers -1 --results_path results/results_newstsc_newstscemn1 --cuda_devices SGE_GPU --combi_mode default --combi_id 0
echo "finished job"
