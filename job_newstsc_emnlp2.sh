...
#$ -e /data/scc/fhamborg/newstscemn2.err
#$ -m bea
...
echo "starting job"
python controller.py --dataset newstsc2 --experiments_path /data/scc/fhamborg/exp_newstscemn2 --continue_run True --num_workers -1 --results_path results/results_newstsc_newstscemn2 --cuda_devices SGE_GPU --combi_mode default --combi_id 0
echo "finished job"
