#!/bin/bash
###################################
#$ -N newstscemn3           # the name of the job
...
#$ -o /data/scc/fhamborg/newstscemn3.out
#$ -e /data/scc/fhamborg/newstscemn3.err
#$ -m bea
...
echo "starting job"
python controller.py --dataset newstsc3 --experiments_path /data/scc/fhamborg/exp_newstscemn3 --continue_run True --num_workers -1 --results_path results/results_newstsc_newstscemn3 --cuda_devices SGE_GPU --combi_mode default --combi_id 0
echo "finished job"
