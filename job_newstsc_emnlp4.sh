#!/bin/bash
###################################
#$ -N newstscemn4           # the name of the job
...
#$ -o /data/scc/fhamborg/newstscemn4.out
#$ -e /data/scc/fhamborg/newstscemn4.err
#$ -m bea
...
echo "starting job"
python controller.py --dataset newstsc4 --experiments_path /data/scc/fhamborg/exp_newstscemn4 --continue_run True --num_workers -1 --results_path results/results_newstsc_newstscemn4 --cuda_devices SGE_GPU --combi_mode default --combi_id 0
echo "finished job"
