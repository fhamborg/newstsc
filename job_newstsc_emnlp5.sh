#!/bin/bash
###################################
#$ -N newstscemn5           # the name of the job
...
#$ -o /data/scc/fhamborg/newstscemn5.out
#$ -e /data/scc/fhamborg/newstscemn5.err
#$ -m bea
...
echo "starting job"
python controller.py --dataset newstsc5 --experiments_path /data/scc/fhamborg/exp_newstscemn5 --continue_run True --num_workers -1 --results_path results/results_newstsc_newstscemn5 --cuda_devices SGE_GPU --combi_mode default --combi_id 0
echo "finished job"
